...
$(document).on('click', '#home_all_products .categories', function(e)
{
        e.preventDefault();
...
$("#home_all_products .products_category li a").click(function (e) {
    e.preventDefault();

    $(document).find("#home_all_products .products_category .selected").removeClass("selected");
